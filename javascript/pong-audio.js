...
export var wallSound = new soundFile("onlymp3.to - Sephirothvoiceclip.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("paddle sword noise.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("ScoreSound.aup3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("OWA.mp3");
